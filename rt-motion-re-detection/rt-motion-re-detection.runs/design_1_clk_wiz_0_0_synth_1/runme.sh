...
HD_PWD='E:/shabesa/Carleton/cu-fpga-club-s26-project-rt-motion-tracking-re-detection/rt-motion-re-detection/rt-motion-re-detection.runs/design_1_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
